...
boolor_agg(is_integration_contact) as is_integration_contact, --due cart logic to allocate a company, there may be true / false combinations happening e.g. contact 479754101. This will just use if contact has true, then true.
-- Averages & Medians
