...
-- after we hired international reps (covering Sunday 7pm to Friday 5pm)
            ...
            --     and date_part(dow,date_hour) = 0 --sundays after 7pm is fair game
            --     and date_part(hour,date_hour) between 19 and 23
            --     -- and holidays.date is null
            --         then converted_hours.date_hour

            -- when date_hour::date >=  '2021-09-01'
            --     and date_part(dow,date_hour) between 1 and 4 --24/hr coverage M-Thurs
            --     -- and holidays.date is null
            --         then converted_hours.date_hour

            -- when date_hour::date >=  '2021-09-01'
            --     and date_part(dow,date_hour) = 5 --fridays, we rest after 8pm ET
            --     and date_part(hour,date_hour) between 0 and 19
            --     -- and holidays.date is null
            --         then converted_hours.date_hour
