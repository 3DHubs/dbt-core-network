...
left join {{ ref('prep_supply_documents') }}  as oqsl on sci.document_number = oqsl.document_number and oqsl.type = 'quote'
left join {{ ref('prep_supply_integration') }}  as integration on integration.document_number = sci.document_number 
