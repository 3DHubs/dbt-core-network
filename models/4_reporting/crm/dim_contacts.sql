select base.created_at,
       ...
       nullif(json_extract_path_text(first_page_seen_query, 'abt'), '')          as test_name,
       nullif(json_extract_path_text(first_page_seen_query, 'abv'), '')          as test_variant,            
       ...
       case when base.mql_type = 'empty_cart' and  utm_campaign = 'plshallowquicklink' then 'pl_shallowquicklink_empty_cart'
       when first_integration_type_contact is not null then 'pl_' + first_integration_type_contact
       when utm_campaign = 'plshallowquicklink' then 'pl_shallowquicklink'  else base.mql_type end as mql_type,
