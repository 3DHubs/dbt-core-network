...
on rates.transactioncurrency__internalid = netsuite_trn.currency__internalid
    ...
    date_trunc('day', cast(netsuite_trn.createddate as date)) = dateadd(day, 1, date_trunc('day', cast(rates.effectivedate as date))) --todo-migration-test: date_trunc and check why cast is done
