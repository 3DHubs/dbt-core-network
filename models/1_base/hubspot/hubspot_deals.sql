...
select
    ...
    dateadd( second,property_first_time_quote_sent_date__value / 1000, to_timestamp('1970-01-01 00:00:00')) as first_time_quote_sent_date,
    nullif(property_dispute_liability__value, '')::varchar(124) as dispute_liability,
    dateadd(second, property_first_time_response_date__value / 1000, to_date('1970-01-01')) as first_time_response_date,
...
end as im_hs_promised_shipping_at_by_supplier, -- The date entered by the IM deal owner to move the deal stage to "Won In Production." This is referred to as the "Latest Ship By Date" in HubSpot.
    case
    ...
    -- nullif(property_complaint_manager__value, '')::bigint as quality_resolution_specialist_id, -- todo-migration: return field
    null as paid_sales_rep_id,
    -- nullif(property_paid_sales_rep__value, '')::bigint as paid_sales_rep_id, -- todo-migration: return field
    case
    ...
    --     then true
    --     else false
    -- end::boolean as is_production_rfq, -- todo-migration: return field
    case
    ...
    -- nullif(property_im_post_sales_value_score__value, '')::varchar(128) as im_post_sales_value_score, -- todo-migration: return field --show Diego
