...
with hubspot_dealstage_union as
         (
             ...
             select __sdc_primary_key                                             as primary_key,
                    ...
                    dateadd(second, occurredat / 1000, timestamp '1970-01-01 00:00:00') as changed_at 
             ...
             where dateadd(second, occurredat / 1000, timestamp '1970-01-01 00:00:00') >= '2020-06-09 00:00:00.000000'
