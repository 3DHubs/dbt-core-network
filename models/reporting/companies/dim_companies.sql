...
select 
       ...
       hc.notes_last_updated_at,
       hc.notes_last_contacted_at,
...
on lower(hc.industry) = indm.industry
    ...
    left join city_coordinates as cc on cc.city = hc.city and cc.country_id = dc.country_id 
