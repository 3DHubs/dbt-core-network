...
select distinct soq.order_uuid                                                                  as order_uuid,
                ...
                case
                    when cdt.order_uuid is not null and cdt.cdtd_shipped_at >= '2019-10-01' then cdt.cdtd_shipped_at
                    when is_cross_docking_ind = false and ss.shipment_shipped_to_customer_at >= '2019-10-01'
                        then ss.shipment_shipped_to_customer_at
                    when is_cross_docking_ind and ss.shipment_shipped_to_crossdock_at >= '2019-10-01'
                        then ss.shipment_shipped_to_crossdock_at end                            as shipped_at,
                case
