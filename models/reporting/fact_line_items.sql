...
select     li.order_uuid,
           ...
           li.requires_specific_gate_position                                         as has_specific_gate_position,
           li.requires_specific_parting_line                                          as has_specific_parting_line,
           li.unit,
           li.quantity,
           li.has_threads,
           li.infill,
    ...
    from {{ ref('line_items') }} as li
             left join {{ ref('supply_documents') }} as docs on docs.uuid = li.quote_uuid           
             ...
             left join {{ ref('material_subsets') }} as msub on msub.material_subset_id = li.material_subset_id
